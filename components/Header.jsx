...
export default function Header() {
  return (
    <header className="bg-slate-50 lg:fixed  lg:inset-y-0 lg:left-0 lg:flex lg:w-2/5 lg:items-start lg:overflow-y-auto xl:w-1/20">
      <div className="hidden  justify-betwee bg-slate-300 lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl] rounded-lg">
        <span className="font-rowdie  text-slate-900 ">Hosted by </span>
        <span className="font-rowdie mt-4 bg-clip-text text-transparent bg-gradient-to-r  from-black to-pink-400">
          Sergio Serrano
        </span>
      </div>
      <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
        <a className="relative drop-shadow-lg mx-auto block w-48 overflow-hidden rounded-lg bg-slate-200 shadow-xl shadow-slate-200 sm:w-80 sm:rounded-xl lg:w-80 lg:rounded-2xl">
          <img className=" w-full h-full" src="./curacao.webp"></img>
        </a>
        <div className="mt-10 text-center lg:mt-12 lg:text-left">
          <p className="text-4xl font-rowdie font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r  from-black to-pink-400">
            <a href="/"> Plan Vacacional </a>
          </p>
        </div>
